...
var Module = typeof Phobius !== 'undefined' ? Phobius : {};
...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'public/project.data';
...
Module['FS_createPath']('/', 'preload', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_public/project.data');

    };
    Module['addRunDependency']('datafile_public/project.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 1022, "filename": "/preload/phobius.options"}, {"start": 1022, "audio": 0, "end": 30355, "filename": "/preload/phobius.model"}], "remote_package_size": 30355, "package_uuid": "0cd8f87a-6464-4a5c-8a49-e2e1a5482d3e"});
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=42624;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 42672, 4), 42672);
...
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = Phobius;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return Phobius; });
    else if (typeof exports === 'object')
      exports["Phobius"] = Phobius;
